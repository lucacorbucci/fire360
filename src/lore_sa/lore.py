...
from lore_sa.dataset import Dataset, TabularDataset
...
class Lore(object):
    def __init__(
        ...
        dataset: Dataset,
        encoder: EncDec,
        generator: NeighborhoodGenerator,
        surrogate: Surrogate,
    ):
        """
    ...
    def explain(self, x: np.array, num_instances=1000):
        ...
        prediction_surrogate = self.surrogate.dt.predict(z.reshape(1, -1))
        ...
        return {
            ...
            "prediction_surrogate": prediction_surrogate[0],
        }
