	...
	const samples = [
		{
			...
			featureImportance: [
				...
				-0.00492565, 0.09259971, 0.03374485, -0.00093868, 0.00063837,
				0.20458916,
			],
			decisionRules: [
	...
	const renderDecisionTree = () => {
		...
		return (
			<div className="flex flex-col items-center mt-6 relative">
				...
				{/* First decision node */}
				<div
					className={`w-64 p-2 rounded-lg mb-4 text-center text-white ${
						Number(topRules[0][1]) >= 0
							? "bg-blue-500"
							: "bg-red-500"
					}`}
				>
				...
				<div className="flex justify-center w-full">
					<div className="flex flex-col items-center mx-4">
						...
						<div
							className={`w-48 p-2 rounded-lg text-center text-white ${
								Number(topRules[1][1]) >= 0
									? "bg-blue-500"
									: "bg-red-500"
							}`}
						>
